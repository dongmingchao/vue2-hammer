...
const vueBuildInDirections = ['stop','capture','self'];
                ...
                if (Object.keys(direction).length) {
                    Object.keys(direction)
                        ...
                        .forEach(keyName => {
                            ...
                            if (elDirectionArray.indexOf(keyName) === -1 && vueBuildInDirections.indexOf(keyName) === -1) {
                ...
                if (this.customEvents[event]) {
                    ...
                    if (recognizerType === 'tap' || recognizerType === 'pinch' || recognizerType === 'press' || recognizerType === 'rotate') {
                        if (el.__hammerConfig[recognizerType].direction.length !== 0) {
                            console.log('el hammer config', el.hammer,direction);
